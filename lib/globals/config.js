...
var defaults = {
      ...
      babel: {
        compact: true,
        sourceMaps: false // it defaults to false, but babelify change it to inline, so we revert it back to default
      },
...
// adapt to babelify wierd option
defaults.babel.sourceMap = defaults.babel.sourceMaps    
