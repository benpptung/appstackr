...
var isBrowserifyNodeModule = function (module_path) {
  ...
  var resolved;
  try {
    resolved = require.resolve(relative);
...
exports.autoprefixer = function (codes, options, callback) {
  ...
  if (typeof options == 'string' || Array.isArray(options)) {
    /// this is sync function call, should check benchmark to see if we should spawn child process or not in the future
    /// but right now, we have no time to do this....shit!! a lot of sync functions in node modules!!
